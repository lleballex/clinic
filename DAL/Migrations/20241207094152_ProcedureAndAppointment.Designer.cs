...
namespace DAL.Migrations
{
    ...
    [Migration("20241207094152_ProcedureAndAppointment")]
    partial class ProcedureAndAppointment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Entities.Procedure", b =>
                {
                    ...
                    b.Property<int>("AssignedAppointmentId")
                        .HasColumnType("integer")
                        .HasColumnName("assigned_appointment_id");
                    ...
                    b.HasIndex("AssignedAppointmentId");
            ...
            modelBuilder.Entity("DAL.Entities.Appointment", b =>
                {
                    ...
                    b.HasOne("DAL.Entities.Procedure", "Procedure")
                        .WithOne("Appointment")
                        .HasForeignKey("DAL.Entities.Appointment", "ProcedureId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("DAL.Entities.Procedure", b =>
                {
                    b.HasOne("DAL.Entities.Appointment", "AssignedAppointment")
                        .WithMany("AssignedProcedures")
                        .HasForeignKey("AssignedAppointmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DAL.Entities.Appointment", b =>
                {
                    b.Navigation("AssignedProcedures");
